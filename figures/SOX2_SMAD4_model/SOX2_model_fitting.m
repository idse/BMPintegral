...
%initial SOX2 (should just be 1 because of normalization)
...
%linear model of SOX2 inhibition
...
%start with manually chosen values based on SOX2 fit above
alphai = 0.0363;
betai = alphai;
lambdai = 0.0329;
...
%use simulated annealing to fit parameters
