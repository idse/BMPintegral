function [ target_indices, source_indices, total_cost, costs] =...
    framelinker(P, time, imsize, max_distance)
...
A1 = D.*(1 + diff_i).*(1 + diff_a).*I;
A1(D > max_distance.^2) = Inf; %do D.*I instead?
